...
;(function($) {
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        appMgr = function() {
            ...
            playlist.init(options.jPlayer, options.auto_advance);
        ...
        playlistMgr = function() {
            ...
            function init(playlistOptions, auto_advance) {
        ...
        interfaceMgr = function() {
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player clearfix one-half"><div class="player jp-interface one-half"><div class="album-cover"><span class="img"></span></div></div></div><div class="ttw-music-player clearfix one-half last">' +
                        '<div class="player jp-interface one-half">' +
                        '        <div class="player-controls">' +
                        '            <div class="main clearfix">' +
                        '                <div class="play jp-play"><i class="icon-play-circle"></i></div>' +
                        '                <div class="pause jp-pause"><i class="icon-pause"></i></div>' +
						...
						'					 <span class="jp-volume-icon"><i class="icon-volume-up"></i></span>'+
						'                    <span class="jp-volume-bar"><span class="jp-volume-bar-value"></span></span>' +
                        '                    <span class="jp-volume-max"></span>' +
                        '                </span>' +
                        '            </div>' +
                        '        </div>' +
                        '    </div>' +
                        '    <div class="tracklist one-half last">' +
                        '        <ol class="tracks"></ol>' +
            ...
            function setCover() {
                $albumCover.animate({opacity:0}, 'fast', function() {
                    if (!isUndefined(myPlaylist[current].cover)) {
                        var now = current;
                        jQuery('<img src="' + myPlaylist[current].cover + '" alt="album cover" />', this).imagesLoaded(function(){
                            if(now == current)
