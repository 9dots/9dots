<?php
class WaveRedux_Options_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', WaveRedux_TEXT_DOMAIN) . '</a>';
        echo ' <a href="javascript:void(0);" class="redux-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', WaveRedux_TEXT_DOMAIN) . '</a>';
    ...
    //         global $wp_version; //AP: why doesn't this work?!?!
        ...
        if ( $wp_version < "3.5" ) {
            wp_enqueue_script(
                ...
                WaveRedux_OPTIONS_URL . 'fields/upload/field_upload_3_4.js', 
            ...
            wp_enqueue_script(
                'redux-opts-field-upload-js', 
                WaveRedux_OPTIONS_URL . 'fields/upload/field_upload.js', 
                array('jquery'),
                time(),
                true
            );
