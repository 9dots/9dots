...
class Wave_Widget_RecentProjects extends WP_Widget
{
	...
	public function __construct() {
		...
		parent::__construct("wave_widget_recent_projects", WAVE_THEME_NAME . " - Recent Projects", $args);
	}
	...
	public function widget($args, $instance) {
		...
		echo  '<ul class="wave-widget-recent-projects">';
		
		$query = new WP_Query(array('posts_per_page' => $instance['number'], 'post_type' => "portfolio"));
	...
	public function form($instance) {
		...
		if(empty($instance['title'])){
			$instance['title'] = __('Recent Projects', WAVE_TEXT_DOMAIN);
		}
